function heatmap = simplenn_graphical_occlusion(net, im, im_, varargin)
%SIMPLENN_GRAPHICAL_OCCLUSION. Generating a heatmap of feature importance.
%   HEATMAP = SIMPLENN_GRAPHICAL_OCCLUSION(NET, IM, IM_, {SIZE, STRIDE})
...
% the terms of the BSD license (see the LICENCE file).
    ...
    heatmap = simplenn_occlusion(net, im_, parameters{:});
