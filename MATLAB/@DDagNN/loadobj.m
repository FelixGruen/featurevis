...
% LOADOBJ  Initialize a DDagNN object from a structure.
%   OBJ = LOADOBJ(S) initializes a DDagNN objet from the structure
%   S. It is the opposite of S = OBJ.SAVEOBJ().
%   If S is a string, initializes the DDagNN object with data
%   from a mat-file S. Otherwise, if S is an instance of `DDagNN`,
%   returns S.
